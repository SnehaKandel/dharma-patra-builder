  ...
  return (
    <MainLayout>
      <div className="container mx-auto py-16 px-4 text-center">
        <h1 className="text-4xl md:text-5xl font-bold text-asklegal-purple mb-4 theme-transition">Welcome to AskLegal.io</h1>
        <p className="text-xl text-asklegal-purple/80 mb-10 theme-transition">Your interactive legal solution</p>
        
        <div className="max-w-3xl mx-auto card-glassmorphism p-6 mb-16">
          <h2 className="text-2xl font-medium text-asklegal-purple mb-4 theme-transition">Chat with AskLegal</h2>
          ...
          <div className="space-y-4 mb-6">
            <div className="chat-message p-4 rounded-lg">
              <p className="text-sm text-asklegal-purple/70 mb-1 theme-transition">AskLegal • 03:20 PM</p>
          ...
          <div className="flex items-center">
            <input 
              ...
              className="flex-1 p-3 rounded-l-md bg-asklegal-dark/60 border border-r-0 border-asklegal-purple/30 text-asklegal-text focus:outline-none focus:border-asklegal-purple theme-transition"
            />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="card-glassmorphism p-6 h-full flex flex-col">
            <h3 className="text-xl font-medium text-asklegal-purple mb-3 theme-transition">Latest News</h3>
          ...
          <div className="card-glassmorphism p-6 h-full flex flex-col">
            <h3 className="text-xl font-medium text-asklegal-purple mb-3 theme-transition">Kanoon Directory</h3>
          ...
          <div className="card-glassmorphism p-6 h-full flex flex-col">
            <h3 className="text-xl font-medium text-asklegal-purple mb-3 theme-transition">Judicial Petitions and Forms</h3>
